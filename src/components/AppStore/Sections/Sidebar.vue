<template>
    <div class="fixed h-full left-[0rem] top-[0.5rem] right-auto w-[5rem] pl-2 overflow-y-auto">
        ...
        <div @click="activeToggle()" :class="!activeState ? 'bg-w-10 text-w-50 border-w-40 border-2' : 'border-w-10 text-w-50 border-2 cursor-pointer'" rounded="lg" p="3" m-b="3" place="items-center" grid="~ flow-row"
            class="place-content-center">
            <div class="i-ant-design:home-filled" w="8" h="8"></div>
            <span class="mt-2">الرئيسية</span>
        </div>
        <div :class="false ? 'bg-w-10 text-w-50 border-w-40 border-2' : 'border-w-10 text-w-50 border-2 cursor-pointer'" rounded="lg" p="3" m-b="3" place="items-center" grid="~ flow-row"
            class="place-content-center">
