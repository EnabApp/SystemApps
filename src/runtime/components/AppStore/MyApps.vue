<template>
  <div flex="~" w="full" items="center" justify="center">
    <div w="95%"  m-t="2" flex="~ col gap-2" overflow="y-scroll">
      <div v-for="app in appStore.ownedAppsWithoutCore" :key="'app-' + app.id" p="2" rounded="xl"  grid="~ cols gap-3" border="1 secondaryOp" :class="(breakpoint.twoXs) ? 'grid-cols-2 transition-all duration-300 ease-in delay-75' : 'grid-cols-4 transition-all duration-300 ease-in delay-75'">
